...
with open("../data_old/df_mov_mean_std_pick_drop_no_hour_sf_n_o.csv", 'r') as trips_file:
    ...
    with open("../data_old/c_d_generator_dist_sf_n_o.json", "w") as data_generator_file:
        json.dump(data_generator, data_generator_file, cls=NumpyEncoder, indent=4)
    with open("../data_old/timeline_gen_events_sf_n_o.json", "w") as timeline_generator_file:
